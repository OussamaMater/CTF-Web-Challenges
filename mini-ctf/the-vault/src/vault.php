            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        ?><tr>
                                    <td>
                                        <div onclick="vault_delete('<?= ms($row[0]); ?>')" style='cursor:pointer'><?= ms($row[0]); ?></div>
                                    </td>
                                    <td><?= ms($row[1]); ?></td>
                                    <td>
                                        <div onclick="vault_show('<?= ms($row[0]); ?>')" id='id_<?= ms($row[0]); ?>' style='cursor:pointer'>***********</div>
                                    </td>
                                    <td><?= ms($row[2]); ?></td>
                                </tr>
                        <?php
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <center><?= ms($_SESSION['user_agent']); ?></center>
                                </td>
                                <td>
                                    <center><?= ms($_SESSION['ip']); ?></center>
                                </td>
                            </tr>
                        </tbody>
                    </table>
